...
function resu(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25,x26,x27,x28,
    ...
    var parameters = {
        ...
        5: ["Объемный расход эжектируеющего потока при рабочих условиях","м<sup>3</sup>/с", "Q<sub>1</sub>",x5.toFixed(3)],
        6: ["Массовый расход эжектируеющего потока при рабочих условиях","м<sup>3</sup>/с", "G<sub>1</sub>",x6.toFixed(3)],
